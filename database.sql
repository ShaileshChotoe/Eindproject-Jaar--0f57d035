...
<body>
    ...
    ('LEVEL2: P', 'Het p element staat voor "paragraph". 
                                ...
                                <br>
                                Nu gaan we een paragraaf toevoegen met daarin een korte introductie over jezelf.
                                ', '', '', 'p', '&#x3C;p&#x3E;&#x3C;/p&#x3E;'),


    ('LEVEL3: img', 'Afbeeldingen in HTML toevoegen gaat door middel van het IMG element. 
                                Een IMG element heeft een "src" attribuut waar een link naar een afbeelding kan worden meegegeven(bijv. een link van een foto op google en kies een PNG, JPEG of GIF). 
    ...
    ('LEVEL4: a', 'Als je gebruikers door wilt sturen op je website kan je gebruik maken van links. Voeg een link to aan je website naar een van je social media. Het anchor element maakt van de inhoud van het element een link. Deze link verwijst naar de locatie aangegeven met het "href" attribuut. Het anchor element ziet er zo uit:', '', '', 'a', '&#x3C;a href=&#x22;De link&#x22;&#x3E;Mijn website&#x3C;/a&#x3E;'),

    ('LEVEL5: li', 'Een lijst element in HTML zorgt voor een gestructureerde weergave van een lijst. Dit kan met bullet points in een unordered list of met een genummerde lijst in een ordered list. Voor elk punt in de lijst moet je opnieuw het ul element in je li element gebruken. 
    ...
    ('LEVEL6: input&button', 'Input is een element waarmee de gebruiker informatie in kan vullen in de browser. 
                                ...
                                <br>Voor een button gebruiken we ook een input element. 
                                    ...
                                    <br>Voeg een input veld toe met daaronder een button.', '', '', '<input>', '&#x3C;input type=&#x22;text&#x22;&#x3E;<br>&#x3C;input type=&#x22;submit&#x22;&#x3E;'),
    ...
    ('LEVEL7: h1 kleur', 'We zijn nu klaar met het HTML gedeelte, we gaan nu naar het CSS deel.
                                ...
                                Hier gaan we het eerder geplaatste h1 element een kleur geven. Op de plek van blue kan je ook een andere kleur zetten of je kan een kleurcode gebruiken bijvoorbeeld #22FFE9.', '', 'body 
{
    background: white;
}
...
.end{}', 'color', 'h1{
    ...
    ('LEVEL10: text style', ' Hier gaan we de paragraph een style geven door het schuingedrukt te maken.
