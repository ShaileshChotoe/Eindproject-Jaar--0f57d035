                ...
                <section class="programme">
                    <div class="row mb-5 pb-5">
                        <div class="col-12 col-md-10 col-lg-9 col-xl-8">
                            <h1 class="mb-5 mb-md-4 u-hyphens">MIJN WEBSITE</h1>
                            <h4>Vul je email in om jouw website te sturen</h4>
                            <br>
                            <br><br>
                            <div>
                                <form action="../server/sendmail.php" method="post">
                                    <input class="input px-md-3 w-md-100 " type="email"
                                        placeholder="Vul hier je email in" name="email">
                            </div>
                            <p>
